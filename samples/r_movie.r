...
mainwin: layout/size [
	...
	text 50 "Height" m1: info 50
	text 50 "Width" m2: info 50
	text 50 "Frames " m3: info 50
	text 50 "fps" m4: info 50
	
	btn 95 "Quit" [ if isFile [cvReleaseImage image] quit]
	space 0x0
	...
	at 5x540
	txt 100 "Frame" sl1: slider 300x20 [if isFile [getFrame "image"]] m5: info 50 "0" m6: info 70 m7: info 70
