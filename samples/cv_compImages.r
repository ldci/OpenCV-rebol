...
&s0: as-pointer! cvCreateImage img/width img/height IPL_DEPTH_8U 1
&s1: as-pointer! cvCreateImage img/width img/height IPL_DEPTH_8U 1
&s2: as-pointer! cvCreateImage img/width img/height IPL_DEPTH_8U 1
&dst: as-pointer! cvCreateImage img/width img/height IPL_DEPTH_8U 1
