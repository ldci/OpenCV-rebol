...
&gray: as-pointer! cvCreateImage src/width src/height IPL_DEPTH_8U 1
;to transform to 32-bit image
&dst: as-pointer! cvCreateImage src/width src/height IPL_DEPTH_32F 3
&dst2: as-pointer! cvCreateImage src/width src/height IPL_DEPTH_8U 3
